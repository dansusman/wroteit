...
export class FakeThings1623541609576 implements MigrationInterface {
  public async up(_: QueryRunner): Promise<void> {
    // await queryRunner.query(`insert into post (title, text, "originalPosterId", "createdAt") values ('Maid, The (Nana, La)', 'Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.
